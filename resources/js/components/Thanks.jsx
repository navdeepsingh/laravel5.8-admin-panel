              ...
              <div className="row">
                <div className="col-md-12 text-center py-2">
                  ...
                  <ul className="list-inline social-links">
                    ...
                    <li className="list-inline-item"><a href="mailto:marketing@brotzeit.co" target="_blank"><i class="fa fa-envelope"></i></a></li>
                  </ul>
                  ...
                  <p className="py-2"><a href="http://brotzeit.co/promotion/oktoberfest-2019/?utm_source=microsite&utm_medium=referral&utm_campaign=free_beer%20&utm_content=thankyou_page" target="_blank"><img src="./images/2019-08-06_Brotzeit_OktoBeerCampaignThankYouPage_PromoBanner_RO.jpg" /></a></p>
