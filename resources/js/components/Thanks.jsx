              ...
              <div className="row">
                <div className="col-md-12 text-center py-2">
                  ...
                  <ul className="list-inline social-links">
                    ...
                    <li className="list-inline-item"><a href="https://twitter.com/intent/tweet?text=Original%20Oktoberfest%20beer%20imported%20from%20Germany%20-%20while%20stocks%20last!%20http%3A%2F%2Foktoberfest.brotzeit.co"
                      rel="noopener" target="_blank"><i className="fa fa-twitter"></i></a></li>
                    <li className="list-inline-item"><a href="mailto:enteryourfriend@addresshere?subject=Hey there, here’s a free beer!&body=Come join me at Brotzeit for a free mug of original Oktoberfest beer! Visit http://oktoberfest.brotzeit.co/redemption to redeem it now." target="_blank"><i className="fa fa-envelope"></i></a></li>
                  </ul>
                  ...
                  <p className="py-2"><img src="./images/2019-08-14_Brotzeit_OktoBeerThankYou_MainHeader_RO.jpg" className="img-fluid" /></p>
