            ...
            <div className="col-md-12 text-center py-5">
              ...
              <div className="row">
                <div className="col-md-12 text-center py-2">
                  ...
                  <p className="share-text">
                    Share on Whatsapp <a href={"https://api.whatsapp.com/send?text=" + config.whatsapp} target="_blank">here</a>.
                  </p>
                  ...
                  <p className="pt-5 pb-2"><a href="http://brotzeit.co/promotion/oktoberfest-2019/?utm_source=microsite&utm_medium=referral&utm_campaign=free_beer&utm_content=thankyou_page" target="_blank"><img src="./images/2019-08-14_Brotzeit_OktoBeerThankYou_MainHeader_RO.jpg" className="img-fluid" /></a></p>
